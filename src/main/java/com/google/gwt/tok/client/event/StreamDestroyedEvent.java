...
public class StreamDestroyedEvent extends GwtEvent<SessionHandler> {

	private JavaScriptObject obj;

	public StreamDestroyedEvent(JavaScriptObject jso) {
		this.obj = jso;
	}

	@Override
	protected void dispatch(SessionHandler handler) {
		handler.onStreamDestroyed(this);
	}
	...
	private native JsArray<JavaScriptObject> _getStreams() /*-{
		return this.@com.google.gwt.tok.client.event.StreamDestroyedEvent::obj.streams;
	}-*/;
}
